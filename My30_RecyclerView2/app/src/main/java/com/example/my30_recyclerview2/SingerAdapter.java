...
public class SingerAdapter extends
    ...
    public SingerDto getItm(int position){
    ...
    //인터페이스에 정의된 메소드 구현
    // 5. 뷰 홀더의 클릭리스너를 실행해 클릭한 위치를 메인에게 알려준다.
    @Override
    ...
    // ViewHolder : xml에 있는 위젯 전체 불러올수있음
